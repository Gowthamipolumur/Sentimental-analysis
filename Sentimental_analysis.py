...
def get_tweet():
   ...
   plt.show()                     
   return render_template("get_tweets.html",query=query,list_tweets=list_tweets,process_tweets=process_tweets,sent=tweets_sent,length=len(process_tweets))
